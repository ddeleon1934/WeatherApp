...
class WeatherApp(QWidget):
    def __init__(self):
        ...
        self.get_weather_button = QPushButton("Display Weather", self)
    ...
    def initUI(self):
        self.setWindowTitle("Simple Weather Display App")
    ...
    def get_weather(self):
        api_key = "ee65fbbb22b06bd1e9032b406dd44f30"
        ...
        try:
            ...
            self.display_error("Too many redirectects:\nCheck the URL")
